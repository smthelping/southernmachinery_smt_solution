  ...
  products: [
    ...
    /* ---------------- 整线与板处理 ---------------- */
    {
      ...
      specs: {
        ...
        '原文矛盾提示 / Source Conflict': 'SBI330 在库内两份原始资料中口径不一致：一份列为「PCB 翻转机（180°）」500×786×1200 / 120 kg，另一份列为「90° 转角输送机」500×563×1200 / 150 kg。本条目按 2 份资料的多数口径收录为翻转机，报价前请与厂家确认实际配置',
    ...
    /* ======================================================================
     * 2026 LED SMT 整线（型号与参数逐条摘自库内 2026 LED 整线方案原文，
     *   出处见各条目 sources 字段；本文件会对外发布，注释中不写文档名与路径）
     ...
     *   每条 sources 指向库内原始文档，可回溯核对（对外发布时该字段会被抹除）。
     * ====================================================================== */
    {
      id: 'S-7180',
      model: 'S-7180',
